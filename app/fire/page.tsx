...
export default async function FireOps7Landing() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-24 text-center">
        ...
        <div className="mx-auto mb-6 mt-6 flex h-20 w-20 items-center justify-center rounded-full bg-red-700 shadow-lg shadow-red-900/50">
      ...
      <footer className="border-t border-zinc-800 bg-zinc-950">
        <div className="mx-auto max-w-6xl px-6 py-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
          ...
          <p className="text-xs text-zinc-600">Built for fire departments. &copy; {new Date().getFullYear()} MuniOps.</p>
