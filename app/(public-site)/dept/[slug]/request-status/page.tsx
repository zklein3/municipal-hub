...
export default async function RequestStatusPage({
  ...
  return (
    <div className="max-w-lg">
      ...
      {!permit && !recordRequest ? (
        <div className="rounded-xl bg-white border border-zinc-200 p-8 text-center">
          <p className="text-sm font-medium text-zinc-700 mb-1">No request found</p>
          <p className="text-xs text-zinc-400">Check your confirmation code and try again.</p>
          <p className="text-xs font-mono text-zinc-300 mt-2">{normalizedCode}</p>
        </div>
